...
function ZaloStrategy(options, verify) {
  console.log('ZALO STRATEGY')
  console.log(typeof options)
  console.log(options)
  console.log('ZALO STRATEGY END')
...
ZaloStrategy.prototype.authenticate = function (req, options) {
  console.log('=== ZALO REQ ===')
  console.log(req.query)
  console.log('=== ZALO REQ END ===')
  console.log('=== ZALO OPTION ===')
  console.log(options)
  console.log('=== ZALO OPTION END ===')
  options = options || {};
  var self = this;
  console.log('=== OPTIONS ===')
  console.log(options)
  ...
  if (req.query && req.query.code) {
    ...
    console.log('AUTH URL OBJ')
    console.log(authUrlObject)
    console.log('FORMATTED')
    console.log(url.format(authUrlObject))
